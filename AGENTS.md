# ruby-live-transcription

Ruby (Sinatra) demo app for Deepgram Live Transcription.
...
```
feat(ruby-live-transcription): add diarization support
fix(ruby-live-transcription): resolve WebSocket close handling
refactor(ruby-live-transcription): simplify session endpoint
