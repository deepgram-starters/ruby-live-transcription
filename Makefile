...
help:
	@echo "Ruby Live Transcription - Available Commands"
	@echo "============================================="
	@echo ""
	@echo "Setup:"
...
check-prereqs:
	...
	@command -v ruby >/dev/null 2>&1 || { echo "ruby is required but not installed. Visit https://www.ruby-lang.org/en/downloads/"; exit 1; }
